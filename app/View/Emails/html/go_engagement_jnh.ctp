...
<p>
	Cette année se déroule la 5ème édition des Journées Nationales Handisport du 13 au 16 avril 2016 !<br/>
	Venez participer à cet événement incontournable du mouvement handisport.<br/>
	Retrouvez un site entièrement accessible au sein de l’Espace Congrès du Westotel de La Chapelle-sur-Erdre, au nord de Nantes.<br/><br/>
	Clubs, sections, établissements, comités : <b>c’est notre rendez-vous ! </b><br/>

	Les Journées 2016 seront à nouveau une belle opportunité d’échanger, partager et profiter des forums, retours d’expériences, conférences, formations ou nombreuses tables rondes. 
<hr>
...
Avec cette nouvelle procédure, vous aurez la possibilité  :<br/>
